...
import (
	...
	"gorm.io/gorm"
	"github.com/SoegiDev/AuthorizationGo"
)
...
func TestMain(m *testing.M) {
	...
	if os.Getenv("env") == "testing" {
		...
		dsn = fmt.Sprintf("host=localhost user=postgres password=%s dbname=gorm port=9920 sslmode=disable TimeZone=Asia/Shanghai",
...
func TestCreateRole(t *testing.T) {
	...
	auth := AuthorizationGo.New(AuthorizationGo.Options{
